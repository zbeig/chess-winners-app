            ...
            for (Player player : players) {
                ...
                if (isNumber(categoryPrize.getPrize())) {
                    if (Integer.valueOf(player.getPrizeMoney()) < Integer.valueOf(categoryPrize.getPrize())) {
                        ...
                        // only age type category U08,F11 etc
                        if (isAgeType(categoryPrize.getCategory())) {
                            Integer ageCat = extractAgeFromType(categoryPrize.getCategory());
